...
// JS 맛보기
// 버튼 클릭시 body 태그 글자색, 배경색을 변경
// HTML 문서에서 body 태그 선택
const body = document.querySelector("body");
// lightMode 변경 함수(기능) 선언
function lightMode(){
  // 함수 정의
  body.style.color="black"; // body 태그의 글자색을 black으로 설정
  body.style.backgroundColor="white"; // 배경색 white로 설정
}
// darkMode 변경 함수(기능) 선언
function darkMode(){
  body.style.color="white"; // 글자색 white로 설정
  body.style.backgroundColor="black"; // 배경색 black으로 설정
}