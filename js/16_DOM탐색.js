...
// # test2의 부모 요소 parentElement
console.log(test2.parentElement);

// # test2의 첫 번째 자식 요소 firstElementChild
console.log(test2.firstElementChild);

// # test2의 마지막 자식 요소 lastElementChild
console.log(test2.lastElementChild);

// # test2의 이전 형제 요소 preciousElementsibling
console.log(test2.previousElementSibling);

// # test2의 다음 형제 요소 nextElementSibling
